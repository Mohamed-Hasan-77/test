...
export default function Footer() {
    return (
    <div id="footer">
        <div className="container flex justify-center items-center flex-wrap py-20">
            ...
            <div className="footerRight w-full lg:w-2/3 text-white flex lg:p-16 py-16  flex-wrap md:flex-nowrap">
                    <div className="footerTitle ">
                        <h3 className='text-3xl font-bold'>
                            Get In Touch With Smart Zones<sup className="font-2 fw-light mr-1">®  </sup>
                        ...
                        <p className=" my-7 fw-light flex ">
                            ...
                            <span className='font-bold text-sm'> 11th Floor, Suite No. 1108, Silver Tower, Downtown, Business Bay, DUBAI UAE </span>
                        </p>


                        <div className="map">

                        <iframe className="w-full rounded-2xl " width="600" height="300" style={{border: "0"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d57768.82416662278!2d55.22928737910159!3d25.184617199999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f69d192597da3%3A0x58177960c29b6340!2sSMART%20ZONES%20UAE!5e0!3m2!1sen!2sae!4v1688993271807!5m2!1sen!2sae"></iframe>
                        </div>
                    </div>
            </div>
        ...
        <div className="footerBottom text-white  py-6">
            ...
            <div className="imgs flex lg:order-2 w-full lg:w-1/3 justify-center items-center  gap-3">
                ...
                <p className="copyright flex justify-center items-center lg:order-1 w-full lg:w-1/3  text-light  mb-0">© 2013 - 2024 Smart Zones<sup className="text-xs fw-light">®</sup> GROUP, All Rights Reserved</p>


                <div className="flex items-center justify-center lg:order-3 w-full lg:w-1/3 d-flex gap-4 "> <a href="https://smartzonesuae.com/privacy-policy/" title="Privacy Policy" className="font-2 text-light text-decoration-none fw-light">Privacy Policy</a> <a href="https://smartzonesuae.com/terms-and-conditions/" title="Terms and Conditions" className="font-2 text-light text-decoration-none fw-light">Terms and Conditions</a> <a href="https://smartzonesuae.com/cookies-policy/" title="Cookies Policy" className="font-2 text-light text-decoration-none fw-light">Cookies Policy</a> </div>
            </div>
