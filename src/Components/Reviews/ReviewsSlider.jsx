...
<div className="sliderOBox px-5   ">
    ...
    <div className="sliderInnerBox rounded-2xl shadow-2xl  flex flex-col items-center justify-center p-7 py-10">
        <div className="title flex items-center">  <span className="bg-mainColor"> R </span>Robbie Nassif</div>
        
        <p className="mt-3">
            I was really impressed what Smart Zones <sup className="font-2 fw-light">®</sup> 
...
<div className="sliderOBox px-3   ">
    ...
    <div className="sliderInnerBox rounded-2xl shadow-2xl  flex flex-col items-center justify-center p-7 py-10">
        <div className="title flex items-center">  <span className="bg-mainColor"> A </span> Arpit tomar </div>
        
        <p className="mt-3">
            Got my residence visa from Smart Zones <sup className="font-2 fw-light">®</sup> 
...
<div className="sliderOBox px-3   ">
    ...
    <div className="sliderInnerBox rounded-2xl shadow-2xl  flex flex-col items-center justify-center p-7 py-10">
        <div className="title flex items-center">  <span className="bg-mainColor"> K </span> KVC Consulting</div>
...
<div className="sliderOBox px-3   ">
    ...
    <div className="sliderInnerBox rounded-2xl shadow-2xl  flex flex-col items-center justify-center p-7 py-10">
        <div className="title flex items-center">  <span className="bg-mainColor"> M </span> Maryam Al-Abri </div>
...
<div className="sliderOBox px-3   ">
    ...
    <div className="sliderInnerBox rounded-2xl shadow-2xl  flex flex-col items-center justify-center p-7 py-10">
        <div className="title flex items-center">  <span className="bg-mainColor"> B </span> Bev Atienza </div>
        
        <p className="mt-3">
            I was so uncertain for putting up a business because I thought there will some 
            hassles with complying with the requirements and all. But, a friend suggested me Smart Zones
        </p>
...
<div className="sliderOBox px-3   ">
    ...
    <div className="sliderInnerBox rounded-2xl shadow-2xl  flex flex-col items-center justify-center p-7 py-10">
        <div className="title flex items-center">  <span className="bg-mainColor"> R </span> Rahul Alurkar </div>
        
        <p className="mt-3">
            SMART ZONES <sup className="font-2 fw-light">®</sup> 
...
<div className="sliderOBox px-3   ">
    ...
    <div className="sliderInnerBox rounded-2xl shadow-2xl  flex flex-col items-center justify-center p-7 py-10">
        <div className="title flex items-center">  <span className="bg-mainColor"> L </span> Luke Desmaris </div>
        
        <p className="mt-3">
            A massive thank you to the Smart Zones <sup className="font-2 fw-light">®</sup> 
...
<div className="sliderOBox px-3   ">
    ...
    <div className="sliderInnerBox rounded-2xl shadow-2xl  flex flex-col items-center justify-center p-7 py-10">
        <div className="title flex items-center">  <span className="bg-mainColor"> A </span> Abdel Hamid </div>
        
        <p className="mt-3">
            Well reputed Expert, experienced staff. I recommended to you smart zones
        </p>
