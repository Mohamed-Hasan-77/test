    ...
    <div className="StartYourJourney bg-white py-32">
        ...
        <div className="container flex  items-center justify-between flex-wrap overflow-hidden lg:overflow-visible">
            ...
            <div className="text w-full lg:w-1/2 mt-24 lg:mt-0">
                <h3>
                What Makes <br/>
                <span className="text-mainColor">  <span className="under-line"> Smart Zones  </span> <sup className="font-2 fw-light">®</sup>  UAE Different?   </span>
                </h3>
                    ...
                    <div className="m-2 space-y-5">
                        ...
                        <div className="group g1 flex flex-col  bg-white rounded-2xl  shadow-lg   "  tabIndex="1">
                            <div className="flex cursor-pointer group-focus:bg-mainLinearColorTwo p-3 px-4 items-center  rounded-2xl justify-between">
                                ...
                                <span className="flex items-center "> <img src={pointImg} className="mr-2 w-6 " alt="point" /> Fast and Efficient </span>
                        ...
                        <div className="group g2 flex flex-col  bg-white rounded-2xl  shadow-lg   "  tabIndex="2">
                            <div className="flex cursor-pointer group-focus:bg-mainLinearColorTwo p-3 px-4 items-center  rounded-2xl justify-between">
                                ...
                                <span className="flex items-center "> <img src={pointImg} className="mr-2 w-6 " alt="point" /> Cost-Effective Solutions </span>
                                <img src={ArrowDown} className="h-4 w-4 transition-all duration-300 group-focus:-rotate-180" />
                        ...
                        <div className="group g3 flex flex-col  bg-white rounded-2xl  shadow-lg   "  tabIndex="3">
                            <div className="flex cursor-pointer group-focus:bg-mainLinearColorTwo p-3 px-4 items-center  rounded-2xl justify-between">
                                ...
                                <span className="flex items-center "> <img src={pointImg} className="mr-2 w-6 " alt="point" /> Multilingual Assistance </span>
                                <img src={ArrowDown} className="h-4 w-4 transition-all duration-300 group-focus:-rotate-180" />
                        ...
                        <div className="group g4 flex flex-col  bg-white rounded-2xl  shadow-lg   "  tabIndex="4">
                            <div className="flex cursor-pointer group-focus:bg-mainLinearColorTwo p-3 px-4 items-center  rounded-2xl justify-between">
                                ...
                                <span className="flex items-center "> <img src={pointImg} className="mr-2 w-6 " alt="point" /> Expert Knowledge </span>
                                <img src={ArrowDown} className="h-4 w-4 transition-all duration-300 group-focus:-rotate-180" />
                        ...
                        <div className="group g5 flex flex-col  bg-white rounded-2xl  shadow-lg   "  tabIndex="5">
                            <div className="flex cursor-pointer group-focus:bg-mainLinearColorTwo p-3 px-4 items-center  rounded-2xl justify-between">
                                ...
                                <span className="flex items-center "> <img src={pointImg} className="mr-2 w-6 " alt="point" /> One-Stop-Shop for all Services</span>
                                <img src={ArrowDown} className="h-4 w-4 transition-all duration-300 group-focus:-rotate-180" />
                        ...
                        <div className="group g6 flex flex-col  bg-white rounded-2xl  shadow-lg   "  tabIndex="6">
                            <div className="flex cursor-pointer group-focus:bg-mainLinearColorTwo p-3 px-4 items-center  rounded-2xl justify-between">
                                ...
                                <span className="flex items-center "> <img src={pointImg} className="mr-2 w-6 " alt="point" /> Robust Network</span>
                                <img src={ArrowDown} className="h-4 w-4 transition-all duration-300 group-focus:-rotate-180" />
                        ...
                        <div className="group g7 flex flex-col  bg-white rounded-2xl  shadow-lg   "  tabIndex="7">
                            <div className="flex cursor-pointer group-focus:bg-mainLinearColorTwo p-3 px-4 items-center  rounded-2xl justify-between">
                                ...
                                <span className="flex items-center "> <img src={pointImg} className="mr-2 w-6 " alt="point" />  Tailored Solutions</span>
                                <img src={ArrowDown} className="h-4 w-4 transition-all duration-300 group-focus:-rotate-180" />
                        ...
                        <div className="group g8 flex flex-col  bg-white rounded-2xl  shadow-lg   "  tabIndex="8">
                            <div className="flex cursor-pointer group-focus:bg-mainLinearColorTwo p-3 px-4 items-center  rounded-2xl justify-between">
                                ...
                                <span className="flex items-center "> <img src={pointImg} className="mr-2 w-6 " alt="point" /> Outstanding Customer Support </span>
                                <img src={ArrowDown} className="h-4 w-4 transition-all duration-300 group-focus:-rotate-180" />
