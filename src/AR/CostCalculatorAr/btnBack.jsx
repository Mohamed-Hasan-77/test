...
export default function BtnBack({Backward}) {

    
  return (

        <button onClick={() =>  Backward()} className="bg-mainBackColor py-3 border-gray-200 border shadow px-10 flex justify-center items-center space-x-2  rounded-2xl text-white ">
